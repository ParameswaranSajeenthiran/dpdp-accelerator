 ...
 * detail-page id. See tests/03-purposes/03.01-admin-creating-purposes.spec.ts for creation-form
 * validation and the detail page's own field round-trip.
 */
test.describe('Admin viewing the Purposes list (UI)', () => {
  ...
  test('03.02.03 - The rows-per-page control caps the number of rendered rows at the selected size', async ({
    ...
    // admin API - see 03.01-admin-creating-purposes.spec.ts for the create-form coverage itself.
    const seedCount = 11
