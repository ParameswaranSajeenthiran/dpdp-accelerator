...
test.describe('Account deletion visibility (UI)', () => {
  test('07.02.01 - A user is offered account deletion in the profile menu', async ({ browser }) => {
  ...
  test('07.02.02 - A Consent Admin is not offered account deletion', async ({ browser }) => {
