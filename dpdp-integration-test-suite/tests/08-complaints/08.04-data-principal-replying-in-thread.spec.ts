 ...
 * officer asked for information, see 08.04.05) and RESOLVED (a reply is the only way a closed
 * complaint reopens, see 08.04.08). Every other status (OPEN, IN_PROGRESS) posts the reply with
 * no toStatus at all and is left unchanged - see 08.04.04 and 08.04.06.
 */
test.describe('Data Principal replying in a complaint thread (UI)', () => {
  test('08.04.01 - Sending a reply appends it to the activity feed', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test("08.04.02 - Sending a reply clears the composer's text field", async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.04.03 - The composer has no "Internal note" toggle for a Data Principal', async ({
    browser,
    userComplaintApi,
  }) => {
  ...
  test('08.04.04 - Replying to a freshly-OPEN complaint posts the message without changing its status', async ({
    browser,
    userComplaintApi,
  }) => {
  ...
  test('08.04.05 - Replying to a complaint the officer asked for more information on routes it back for internal review', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.04.06 - Replying while the complaint is In Progress posts the message without changing its status', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.04.07 - "Attach" is disabled while a file is staged, and removing it lets a different file be attached', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.04.08 - Replying to a resolved complaint reopens it for internal review', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
