...
test.describe('Real-world complaint scenarios (UI)', () => {
  ...
  test('08.09.02 - A multi-round officer/citizen exchange leaves the whole thread visible to both sides', async ({
    browser,
    userComplaintApi,
  }) => {
    ...
    //
    // What makes this catch it where 08.07.01's single reply does not: several rounds, each read
    ...
    //
    // Many full-page navigations, each forcing a silent OIDC re-auth round trip (see 08.05.01) -
