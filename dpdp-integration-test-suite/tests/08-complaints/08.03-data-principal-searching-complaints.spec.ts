 ...
 * 08.06-officer-searching-complaints.spec.ts). This environment never resets (see the suite root
...
test.describe('Data Principal searching/filtering complaints (UI)', () => {
  test('08.03.01 - Filtering to "Open" shows an Open complaint and hides an In Progress one', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.03.02 - Filtering to "In Progress" shows the In Progress complaint and hides the Open one', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
  ...
  test('08.03.03 - Clearing the status filter (back to "All") restores complaints of every status', async ({
    browser,
    userComplaintApi,
    officerComplaintApi,
  }) => {
