 ...
 * `05.01-route-redirects.spec.ts` already proves for the super tenant's plain `user` persona
...
test.describe('Tenant user role scoping (UI)', () => {
  test('06.03.01 - The tenant\'s second user, holding only dpdp-consent-user, is redirected away from /purposes', async ({
    browser,
    tenant,
  }) => {
