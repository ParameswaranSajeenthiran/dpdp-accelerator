...
test.describe('Sidebar navigation visibility (UI)', () => {
  test("05.02.01 - A user's sidebar shows only the Dashboard and Consent sections", async ({
    browser,
  }) => {
  ...
  test('05.02.02 - A Consent Admin\'s sidebar shows every section, including Definitions and Administration', async ({
    browser,
  }) => {
