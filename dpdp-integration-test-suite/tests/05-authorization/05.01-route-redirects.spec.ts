...
test.describe('Route-level access control (UI)', () => {
  test('05.01.01 - A user navigating directly to /purposes is redirected to the dashboard', async ({
    browser,
  }) => {
  ...
  test('05.01.02 - A user navigating directly to /elements is redirected to the dashboard', async ({
    browser,
  }) => {
    const userPage = await loginAsUser(browser)
  ...
  test('05.01.03 - A user navigating directly to /administration/consents is redirected to the dashboard', async ({
    browser,
  }) => {
    const userPage = await loginAsUser(browser)
  ...
  test('05.01.04 - A user navigating directly to a Purpose detail page by link is redirected to the dashboard', async ({
    browser,
  }) => {
    const userPage = await loginAsUser(browser)
  ...
  test('05.01.05 - A user navigating directly to an Element detail page by link is redirected to the dashboard', async ({
    browser,
  }) => {
    const userPage = await loginAsUser(browser)
  ...
  test('05.01.06 - A user navigating directly to an admin Consent detail page by link is redirected to the dashboard', async ({
    browser,
  }) => {
    const userPage = await loginAsUser(browser)
