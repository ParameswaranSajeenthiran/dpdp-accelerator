...
class ComplaintCreateResponseDTOTest {
    ...
    void fromMapsEveryFieldFromTheDto() {
        ...
        ComplaintCreateResponseDTO bean = ComplaintCreateResponseDTO.from(complaint);
    ...
    void noArgsConstructorAndSettersRoundTrip() {
        ComplaintCreateResponseDTO bean = new ComplaintCreateResponseDTO();
        bean.setId("c2");
