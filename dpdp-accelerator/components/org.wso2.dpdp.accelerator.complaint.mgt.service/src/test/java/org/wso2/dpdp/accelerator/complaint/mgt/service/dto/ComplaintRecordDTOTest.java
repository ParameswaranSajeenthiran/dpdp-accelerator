...
class ComplaintRecordDTOTest {
    ...
    void fromMapsEveryFieldAndEachAttachment() {
        ComplaintAttachmentResponseDTO attachment = new ComplaintAttachmentResponseDTO("a1", null, "a.pdf",
                "application/pdf", 0L, false, 0L);

        ComplaintRecordDTO bean = ComplaintRecordDTO.from(sampleComplaint(), List.of(attachment));
    ...
    void fromProducesAnEmptyAttachmentListWhenGivenNull() {
        ComplaintRecordDTO bean = ComplaintRecordDTO.from(sampleComplaint(), null);
