...
public class ComplaintCommentCreateResponseDTO {
    ...
    public ComplaintCommentCreateResponseDTO() {
    }

    public static ComplaintCommentCreateResponseDTO from(ComplaintEvent event) {
