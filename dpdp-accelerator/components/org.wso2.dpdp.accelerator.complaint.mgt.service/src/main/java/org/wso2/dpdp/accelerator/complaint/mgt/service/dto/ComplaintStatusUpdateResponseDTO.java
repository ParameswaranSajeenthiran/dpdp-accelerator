...
public class ComplaintStatusUpdateResponseDTO {
    ...
    public ComplaintStatusUpdateResponseDTO() {
    }

    public static ComplaintStatusUpdateResponseDTO from(Complaint complaint) {
        ComplaintStatusUpdateResponseDTO bean = new ComplaintStatusUpdateResponseDTO();
