...
public class ComplaintAttachmentResponseDTO {
    ...
    public ComplaintAttachmentResponseDTO() {
    }

    public ComplaintAttachmentResponseDTO(String attachmentId, String complaintEventId, String fileName,
    ...
    public static ComplaintAttachmentResponseDTO from(ComplaintAttachment attachment) {
        return new ComplaintAttachmentResponseDTO(attachment.getAttachmentId(), attachment.getComplaintEventId(),
