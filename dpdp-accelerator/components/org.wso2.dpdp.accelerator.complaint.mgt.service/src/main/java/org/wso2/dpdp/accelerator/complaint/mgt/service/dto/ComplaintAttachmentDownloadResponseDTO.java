...
public class ComplaintAttachmentDownloadResponseDTO {
    ...
    public ComplaintAttachmentDownloadResponseDTO() {
    }

    public ComplaintAttachmentDownloadResponseDTO(String attachmentId, String fileName, String contentType,
            byte[] rawContent) {
