...
/**
 * Internal entity model representing an Event Subscription in the persistence layer.
 */
public class Subscription {
    ...
    public Subscription(String subscriptionId, String orgId, String groupId, String topicId, String status,
        ...
        this(subscriptionId, orgId, groupId, topicId, status, purposeFilterMode, null, callbackUrl, sharedSecret,
                createdAt, updatedAt, deliveryMode);
    }

    public Subscription(String subscriptionId, String orgId, String groupId, String topicId, String status,
            String purposeFilterMode, List<String> purposes, String callbackUrl, String sharedSecret,
            Timestamp createdAt, Timestamp updatedAt, String deliveryMode) {
