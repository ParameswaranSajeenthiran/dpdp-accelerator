...
/**
 * Shared helpers for dynamic SQL query builders that need a case-insensitive, wildcard-safe
 * "contains" LIKE search - used by more than one feature's DAO query builders (event
 * notifications, complaint management), which is why this lives here rather than in either
 * feature module.
 */
