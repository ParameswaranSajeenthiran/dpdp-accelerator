...
public class DPDPTenantContextTest {
    ...
    public void getOrganizationIdReturnsCurrentTenantDomain() {
        ...
        try {
            PrivilegedCarbonContext.getThreadLocalCarbonContext().setTenantDomain(" acme.com ");
            assertEquals(DPDPTenantContext.getOrganizationId(), "acme.com");
        } finally {
    ...
    @Test
    public void getOrganizationIdRejectsMissingTenantDomain() {
