...
class ComplaintDAOImplTest {
    ...
    @Test
    void listComplaintsSearchMatchesReferenceIdCaseInsensitiveAcrossOrg() {
        // sampleComplaint gives c1 referenceId "CMP-2026-c1" and userName "user1-name" - see helper below.
        dao.addComplaint(sampleComplaint("c1", "org1", "OPEN", "HIGH", "user1", 100L, 100L));
        dao.addComplaint(sampleComplaint("c2", "org1", "OPEN", "HIGH", "user2", 200L, 200L));

        int[] totalOut = new int[1];
        List<Complaint> results = dao.listComplaints("org1", null, null, null, "2026-C1", 10, 0, null, totalOut);
    ...
    @Test
    void listComplaintsSearchMatchesUserNameAndFallsBackToUserId() {
        dao.addComplaint(sampleComplaint("c1", "org1", "OPEN", "HIGH", "user1", 100L, 100L));
        dao.addComplaint(sampleComplaint("c2", "org1", "OPEN", "HIGH", "user2", 200L, 200L));
        ...
        List<Complaint> results = dao.listComplaints("org1", null, null, null, "user1-name", 10, 0, null, totalOut);
    ...
    void listComplaintsSearchTreatsLikeWildcardsLiterally() {
        ...
        List<Complaint> results = dao.listComplaints("org1", null, null, null, "%_%", 10, 0, null, totalOut);
