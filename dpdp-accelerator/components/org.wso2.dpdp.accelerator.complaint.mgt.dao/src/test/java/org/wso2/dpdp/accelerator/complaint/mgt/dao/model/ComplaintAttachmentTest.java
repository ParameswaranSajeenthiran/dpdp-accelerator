...
class ComplaintAttachmentTest {
    ...
    void getSizeBytesPrefersLoadedFileDataOverOverride() {
        ComplaintAttachment attachment = new ComplaintAttachment("a1", "org1", "c1", "file.pdf",
                "application/pdf", new byte[]{1, 2, 3, 4, 5}, true, 100L);
    ...
    void allArgsConstructorPopulatesEveryField() {
        byte[] data = {9, 8, 7};
        ComplaintAttachment attachment = new ComplaintAttachment("a1", "org1", "c1", "file.png", "image/png",
                data, false, 500L);
        ...
        assertEquals(false, attachment.isPublic());
