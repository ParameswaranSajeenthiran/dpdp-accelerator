...
class ComplaintEventTest {
    ...
    void deriveEntryTypeReturnsStatusChangeWhenToStatusIsPresent() {
        ComplaintEvent event = new ComplaintEvent("e1", "org1", "c1", "u1", "User One", "COMPLAINT_OFFICER", true,
    ...
    void deriveEntryTypeReturnsCommentWhenPublicAndNoStatusChange() {
        ComplaintEvent event = new ComplaintEvent("e1", "org1", "c1", "u1", "User One", "USER", true, "hello", null,
                null, 100L);
    ...
    void deriveEntryTypeReturnsInternalNoteWhenNotPublicAndNoStatusChange() {
        ComplaintEvent event = new ComplaintEvent("e1", "org1", "c1", "u1", "User One", "COMPLAINT_OFFICER", false,
    ...
    void noArgsConstructorAndSettersRoundTrip() {
        ...
        event.setActorUserName("User Two");
        ...
        assertEquals("User Two", event.getActorUserName());
