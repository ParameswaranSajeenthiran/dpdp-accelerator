...
class DBUtilTransactionTest {
    ...
    private Complaint sampleComplaint(String id, String status) {
        return new Complaint(id, "org1", "user1", "User One", "CMP-2026-" + id, "DATA_BREACH", "HIGH", status, "desc",
                100L, 100L, 1100L);
    }
    ...
    void statusUpdateAndAuditEventCommitTogetherOnSuccess() throws SQLException {
        ...
        DBUtil.executeInTransaction(conn -> {
            ...
            ComplaintEvent event = new ComplaintEvent("e1", "org1", "c1", "user1", "User One", "COMPLAINT_OFFICER",
                    true, "note", "OPEN", "IN_PROGRESS", 500L);
