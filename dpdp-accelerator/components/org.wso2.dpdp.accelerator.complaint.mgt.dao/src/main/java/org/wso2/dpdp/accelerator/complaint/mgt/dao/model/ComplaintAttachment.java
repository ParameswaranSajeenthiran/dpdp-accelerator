...
public class ComplaintAttachment {
    ...
    // The upload event created alongside this attachment (see ComplaintAttachmentServiceImpl.store) -
    // lets the timeline show which entry a given attachment was added under.
    ...
    public ComplaintAttachment(String attachmentId, String orgId, String complaintId, String fileName,
            String contentType, byte[] fileData, boolean isPublic, long createdTime) {
