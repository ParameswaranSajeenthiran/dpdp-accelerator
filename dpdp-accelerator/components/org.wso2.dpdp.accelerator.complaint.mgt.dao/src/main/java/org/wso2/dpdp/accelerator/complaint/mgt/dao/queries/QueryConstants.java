...
public class QueryConstants {
    ...
    public static final String ADD_COMPLAINT =
            "INSERT INTO COMPLAINT (COMPLAINT_ID, ORG_ID, USER_ID, USER_NAME, REFERENCE_ID, CATEGORY, PRIORITY, " +
            "STATUS, DESCRIPTION, CREATED_TIME, UPDATED_TIME, STATUTORY_DUE_TIME) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    public static final String GET_COMPLAINT_BY_ID =
            "SELECT COMPLAINT_ID, ORG_ID, USER_ID, USER_NAME, REFERENCE_ID, CATEGORY, PRIORITY, STATUS, " +
            "DESCRIPTION, CREATED_TIME, UPDATED_TIME, STATUTORY_DUE_TIME FROM COMPLAINT " +
            "WHERE COMPLAINT_ID = ? AND ORG_ID = ?";
    ...
    public static final String LIST_COMPLAINTS_BASE =
            "SELECT COMPLAINT_ID, ORG_ID, USER_ID, USER_NAME, REFERENCE_ID, CATEGORY, PRIORITY, STATUS, " +
            "DESCRIPTION, CREATED_TIME, UPDATED_TIME, STATUTORY_DUE_TIME FROM COMPLAINT WHERE ORG_ID = ? ";
    ...
    public static final String ADD_COMPLAINT_EVENT =
            ...
            "ACTOR_USER_ID, ACTOR_USER_NAME, ACTOR_ROLE, IS_PUBLIC, COMMENT, FROM_STATUS, TO_STATUS, ACTION_TIME) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static final String GET_COMPLAINT_EVENT_BY_ID =
            ...
            "ACTOR_USER_NAME, ACTOR_ROLE, IS_PUBLIC, COMMENT, FROM_STATUS, TO_STATUS, ACTION_TIME " +
    ...
    public static final String LIST_COMPLAINT_EVENTS_BASE =
            "SELECT " + DAOConstants.COLUMN_COMPLAINT_EVENT_ID + ", ORG_ID, COMPLAINT_ID, ACTOR_USER_ID, " +
            "ACTOR_USER_NAME, ACTOR_ROLE, IS_PUBLIC, COMMENT, FROM_STATUS, TO_STATUS, ACTION_TIME " +
            "FROM COMPLAINT_EVENT WHERE ORG_ID = ? AND COMPLAINT_ID = ? ";
    ...
    public static final String ADD_COMPLAINT_ATTACHMENT =
            ...
            DAOConstants.COLUMN_COMPLAINT_EVENT_ID + ", FILE_NAME, FILE_CONTENT_TYPE, FILE_DATA, IS_PUBLIC, " +
            "CREATED_TIME) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    public static final String GET_ATTACHMENT_METADATA_BY_ID =
            "SELECT ATTACHMENT_ID, ORG_ID, COMPLAINT_ID, " + DAOConstants.COLUMN_COMPLAINT_EVENT_ID + ", FILE_NAME, " +
            "FILE_CONTENT_TYPE, LENGTH(FILE_DATA) AS SIZE_BYTES, IS_PUBLIC, CREATED_TIME " +
    ...
    public static final String GET_ATTACHMENT_WITH_DATA_BY_ID =
            "SELECT ATTACHMENT_ID, ORG_ID, COMPLAINT_ID, " + DAOConstants.COLUMN_COMPLAINT_EVENT_ID + ", FILE_NAME, " +
            "FILE_CONTENT_TYPE, FILE_DATA, IS_PUBLIC, CREATED_TIME FROM COMPLAINT_ATTACHMENT " +
            "WHERE ATTACHMENT_ID = ? AND ORG_ID = ? AND COMPLAINT_ID = ?";

    public static final String LIST_ATTACHMENT_METADATA_BY_COMPLAINT =
            "SELECT ATTACHMENT_ID, ORG_ID, COMPLAINT_ID, " + DAOConstants.COLUMN_COMPLAINT_EVENT_ID + ", FILE_NAME, " +
            "FILE_CONTENT_TYPE, LENGTH(FILE_DATA) AS SIZE_BYTES, IS_PUBLIC, CREATED_TIME " +
            "FROM COMPLAINT_ATTACHMENT WHERE ORG_ID = ? AND COMPLAINT_ID = ? ORDER BY CREATED_TIME ASC";
}
