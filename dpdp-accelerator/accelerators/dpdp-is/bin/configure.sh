...
# schema migration.
# Run this with the server STOPPED, then start it and follow docs/setup-guide.md.
...
# Generated by configure.sh; client credentials are filled in manually,
# see docs/setup-guide.md. This file survives an accelerator upgrade.
...
echo "  2. Follow docs/setup-guide.md to register the portal application."
