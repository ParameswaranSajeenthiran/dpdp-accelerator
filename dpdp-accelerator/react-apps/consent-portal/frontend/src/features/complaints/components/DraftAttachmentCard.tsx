...
function DraftAttachmentCard({
  ...
  useEffect(() => {
    ...
    // Create and revoke within the same effect instance so React's
    // StrictMode dev double-invoke (setup -> cleanup -> setup) doesn't
    // revoke a URL that a later setup is still relying on.
