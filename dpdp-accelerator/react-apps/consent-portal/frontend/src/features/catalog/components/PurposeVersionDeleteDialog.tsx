...
interface PurposeVersionDeleteDialogProps {
  open: boolean
  version: string
  loading: boolean
  error?: string
...
function PurposeVersionDeleteDialog({
  open,
  version,
  loading,
  error,
  onClose,
  onConfirm,
}: PurposeVersionDeleteDialogProps): React.JSX.Element {
...
export default PurposeVersionDeleteDialog
